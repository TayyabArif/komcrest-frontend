...
const KnowledgeHistory = ({questionReferenceData ,setQuestionReferenceData ,statusUpdate }) => {
  ...
  return (
    ...
    <div key={index} className="bg-[#FFFFFF] rounded-md p-4 space-y-3 2xl:text-[20px] text-[16px] break-words " >
